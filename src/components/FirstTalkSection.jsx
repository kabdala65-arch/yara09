...
export default function FirstTalkSection() {
  const { content } = useSiteContent()
  const { firstTalk } = content
  const startDate = new Date(firstTalk.startDate)
  ...
  return (
    <section className="counter-section">
      ...
      >
        <span className="section-tag">{firstTalk.tagText}</span>
        <h2 className="section-title">{firstTalk.title}</h2>
        <p className="section-subtitle">{firstTalk.subtitle}</p>
      </motion.div>
